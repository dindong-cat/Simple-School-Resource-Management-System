...
@WebServlet(name = "resourceDelete", urlPatterns = {"/resourceDelete"})
public class resourceDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            statement.executeUpdate(String.format("DELETE FROM resource WHERE resource_name = \"%s\"", resourceName));
