...
public class bookingDelete extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            resultSet = statement.executeQuery(String.format("SELECT * FROM booking WHERE booking_id = %d;", bookingId));

            statement.executeUpdate(String.format("DELETE FROM booking WHERE booking_id = %d;", bookingId));
